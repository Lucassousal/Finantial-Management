...
const TransactionRowList = React.memo(({ paginatedTransactions, formatDateBR, handleStartEditTrans, confirmDeleteTrans }) => {
  return (
    <>
...
export default function TransactionsTab() {
  ...
  const handleStartEditTrans = useCallback((t) => {
  ...
  // formatCurrency movido para fora do componente

  

  

  const confirmDeleteTrans = useCallback((id, description, amount) => {
                    ...
                    <Table className="text-zinc-750 dark:text-zinc-200">
                      ...
                      <TableBody>
                        <TransactionRowList 
                          ...
                          handleStartEditTrans={handleStartEditTrans} 
                          confirmDeleteTrans={confirmDeleteTrans} 
                        />
                      </TableBody>
                    </Table>
                  </div>
